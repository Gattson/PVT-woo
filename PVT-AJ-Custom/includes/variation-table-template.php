        ...
        <tbody>
            <?php foreach ( $variations as $variation ) :
                ...
                foreach ( $variation_obj->get_attributes() as $key => $value ) {
                    ...
                    $taxonomy = ucfirst( strtolower( $taxonomy ) );
                    $value = ucfirst( strtolower( $value ) );
                    $attributes[] = '<span class="attribute-label">' . esc_html( $taxonomy ) . ':</span> ' . esc_html( $value );
			...
			data-nonce="<?php echo wp_create_nonce('pvt_add_to_cart'); ?>">
                ...
                <td><?php echo wp_kses_post( implode(', ', $attributes) ); ?>
